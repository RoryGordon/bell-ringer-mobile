...
//   BluetoothCharacteristic _getCharFromServices(
//       List<BluetoothService> services) {
...
//   Future<void> _discoverPressed() async {
//     setState(() {});
...
//       //beenPressed = true;
//       char = _getCharFromServices(snapshot.data);
//       return PaintStream(char: char);
//     } else {
//       return RaisedButton(
//         child: Text("Discover Services"),
//         onPressed: () => _discoverPressed(),
//       );
//     }
//   }
